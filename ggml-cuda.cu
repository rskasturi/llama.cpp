...
template <int mmq_y> static __device__ __forceinline__ void allocate_tiles_q4_0(int ** x_ql, half2 ** x_dm, int ** x_qh, int ** x_sc) {
    ...
    __shared__ int  tile_x_qs_q4_0[mmq_y * (WARP_SIZE)       + mmq_y];
    __shared__ float tile_x_d_q4_0[mmq_y * (WARP_SIZE/QI4_0) + mmq_y/QI4_0];

    *x_ql = tile_x_qs_q4_0;
    *x_dm = (half2 *) tile_x_d_q4_0;
}
...
template <int mmq_y> static __device__ __forceinline__ void allocate_tiles_q4_1(int ** x_ql, half2 ** x_dm, int ** x_qh, int ** x_sc) {
    ...
    __shared__ int   tile_x_qs_q4_1[mmq_y * (WARP_SIZE) +     + mmq_y];
    __shared__ half2 tile_x_dm_q4_1[mmq_y * (WARP_SIZE/QI4_1) + mmq_y/QI4_1];
...
template <int mmq_y> static __device__ __forceinline__ void allocate_tiles_q5_0(int ** x_ql, half2 ** x_dm, int ** x_qh, int ** x_sc) {
    ...
    __shared__ int  tile_x_ql_q5_0[mmq_y * (2*WARP_SIZE)     + mmq_y];
    __shared__ float tile_x_d_q5_0[mmq_y * (WARP_SIZE/QI5_0) + mmq_y/QI5_0];

    *x_ql = tile_x_ql_q5_0;
    *x_dm = (half2 *) tile_x_d_q5_0;
}
...
template <int mmq_y> static __device__ __forceinline__ void allocate_tiles_q5_1(int ** x_ql, half2 ** x_dm, int ** x_qh, int ** x_sc) {
    ...
    __shared__ int   tile_x_ql_q5_1[mmq_y * (2*WARP_SIZE)     + mmq_y];
    __shared__ half2 tile_x_dm_q5_1[mmq_y * (WARP_SIZE/QI5_1) + mmq_y/QI5_1];
...
template <int mmq_y> static __device__ __forceinline__ void allocate_tiles_q8_0(int ** x_ql, half2 ** x_dm, int ** x_qh, int ** x_sc) {
    ...
    __shared__ int  tile_x_qs_q8_0[mmq_y * (WARP_SIZE)       + mmq_y];
    __shared__ float tile_x_d_q8_0[mmq_y * (WARP_SIZE/QI8_0) + mmq_y/QI8_0];

    *x_ql = tile_x_qs_q8_0;
    *x_dm = (half2 *) tile_x_d_q8_0;
}
...
template <int mmq_y> static __device__ __forceinline__ void allocate_tiles_q2_K(int ** x_ql, half2 ** x_dm, int ** x_qh, int ** x_sc) {
    ...
    __shared__ int   tile_x_ql_q2_K[mmq_y * (WARP_SIZE)       + mmq_y];
    __shared__ half2 tile_x_dm_q2_K[mmq_y * (WARP_SIZE/QI2_K) + mmq_y/QI2_K];
    __shared__ int   tile_x_sc_q2_K[mmq_y * (WARP_SIZE/4)     + mmq_y/4];
...
template <int mmq_y> static __device__ __forceinline__ void allocate_tiles_q3_K(int ** x_ql, half2 ** x_dm, int ** x_qh, int ** x_sc) {
    ...
    __shared__ int   tile_x_ql_q3_K[mmq_y * (WARP_SIZE)       + mmq_y];
    __shared__ half2 tile_x_dm_q3_K[mmq_y * (WARP_SIZE/QI3_K) + mmq_y/QI3_K];
    __shared__ int   tile_x_qh_q3_K[mmq_y * (WARP_SIZE/2)     + mmq_y/2];
    __shared__ int   tile_x_sc_q3_K[mmq_y * (WARP_SIZE/4)     + mmq_y/4];
...
template <int mmq_y> static __device__ __forceinline__ void allocate_tiles_q4_K(int ** x_ql, half2 ** x_dm, int ** x_qh, int ** x_sc) {
    ...
    __shared__ int   tile_x_ql_q4_K[mmq_y * (WARP_SIZE)       + mmq_y];
    __shared__ half2 tile_x_dm_q4_K[mmq_y * (WARP_SIZE/QI4_K) + mmq_y/QI4_K];
    __shared__ int   tile_x_sc_q4_K[mmq_y * (WARP_SIZE/8)     + mmq_y/8];
...
template <int mmq_y> static __device__ __forceinline__ void allocate_tiles_q5_K(int ** x_ql, half2 ** x_dm, int ** x_qh, int ** x_sc) {
    ...
    __shared__ int   tile_x_ql_q5_K[mmq_y * (2*WARP_SIZE)     + mmq_y];
    __shared__ half2 tile_x_dm_q5_K[mmq_y * (WARP_SIZE/QI5_K) + mmq_y/QI5_K];
    __shared__ int   tile_x_sc_q5_K[mmq_y * (WARP_SIZE/8)     + mmq_y/8];
...
template <int qk, int qr, int qi, bool need_sum, typename block_q_t, int mmq_x, int mmq_y, int nwarps,
            load_tiles_cuda_t load_tiles, int vdr, vec_dot_q_mul_mat_cuda_t vec_dot>
static __device__ __forceinline__ void mul_mat_q(
    const void * __restrict__ vx, const void * __restrict__ vy, float * __restrict__ dst,
    const int ncols_x, const int nrows_x, const int ncols_y, const int nrows_y, const int nrows_dst,
    int   * tile_x_ql,  half2 * tile_x_dm, int   * tile_x_qh, int   * tile_x_sc) {
